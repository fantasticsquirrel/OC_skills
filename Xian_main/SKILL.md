---
name: xian-main
description: Write, test, deploy, and integrate Xian blockchain smart contracts. Use when developing Xian dApps, writing contract logic in Python-subset (Contracting), deploying to Xian network, or integrating contracts with frontend via dapp-utils. Covers the full stack from contract engine to dApp integration.
---
